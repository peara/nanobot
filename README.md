...
| reddit | `python -m nanobot.mcp_servers.reddit.server` | `reddit_get_posts`, `reddit_get_post`, `reddit_search`, `reddit_get_subreddit`, `reddit_health` (no auth needed, see [docs/REDDIT.md](docs/REDDIT.md)) |
